...
function requireOrdersCanMatch(client, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, client.wyvernExchange.ordersCanMatch({
...
function requireOrderCalldataCanMatch(client, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, client.wyvernExchange.orderCalldataCanMatch(buy.calldata, buy.replacementPattern, sell.calldata, sell.replacementPattern).callAsync()];
                case 1:
                    result = _b.sent();
                    if (result) {
                        return [2 /*return*/];
