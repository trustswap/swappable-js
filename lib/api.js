...
var SwappableAPI = /** @class */ (function () {
    /**
     ...
     */
    function SwappableAPI(config, logger) {
        /**
     ...
     */
    SwappableAPI.prototype.postOrder = function (order, retries) {
     ...
     */
    SwappableAPI.prototype.postAssetWhitelist = function (tokenAddress, tokenId, email) {
        return __awaiter(this, void 0, void 0, function () {
            var json;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    SwappableAPI.prototype.getOrder = function (query) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SwappableAPI.prototype.getOrders = function (query, page) {
     ...
     * @param retries Number of times to retry if the service is unavailable for any reason
     */
    SwappableAPI.prototype.getAsset = function (_a, retries) {
     ...
     */
    SwappableAPI.prototype.getAssets = function (query, page) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var json;
     ...
     * @param retries Number of times to retry if the service is unavailable for any reason
     */
    SwappableAPI.prototype.getPaymentTokens = function (query, page, retries) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SwappableAPI.prototype.getBundle = function (_a) {
        var slug = _a.slug;
        return __awaiter(this, void 0, void 0, function () {
            var json;
            return __generator(this, function (_b) {
     ...
     */
    SwappableAPI.prototype.getBundles = function (query, page) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var json;
     ...
     */
    SwappableAPI.prototype.get = function (apiPath, query) {
        if (query === void 0) { query = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var qs, url, response;
            return __generator(this, function (_a) {
     ...
     */
    SwappableAPI.prototype.post = function (apiPath, body, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     *  a body, it won't be stringified.
     */
    SwappableAPI.prototype.put = function (apiPath, body, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    SwappableAPI.prototype._fetch = function (apiPath, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    SwappableAPI.prototype._handleApiResponse = function (response) {
        return __awaiter(this, void 0, void 0, function () {
