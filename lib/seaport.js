...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.cancelOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var gasPrice, orderToCancel, orderToCancelSig, transactionHash;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.cancelOrder.sendTransactionAsync(orderToCancel, orderToCancelSig, { from: accountAddress, gasPrice: gasPrice })];
                    case 2:
    ...
    OpenSeaPort.prototype.getCurrentPrice = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var orderToCalculateCurrentPrice, currentPrice;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.calculateCurrentPrice.callAsync(orderToCalculateCurrentPrice)];
                    case 1:
    ...
    OpenSeaPort.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var orderToHash, hash, confirmedOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        orderToHash = {
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.hashOrder.callAsync(orderToHash)];
                    case 1:
                        hash = _a.sent();
                        if (hash !== order.hash) {
                            console.error(order);
    ...
    OpenSeaPort.prototype._estimateGasForMatch = function (_a, retries) {
        ...
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var value, buyOrder, sellOrder, buySig, sellSig, error_10;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._getClientsForRead(retries).wyvernProtocol.wyvernExchange.atomicMatch.estimateGasAsync(buyOrder, buySig, sellOrder, sellSig, metadata, 
            ...
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.computeFees({ asset: openSeaAsset, extraBountyBasisPoints: extraBountyBasisPoints, side: types_1.OrderSide.Buy, paymentTokenAddress: paymentTokenAddress })];
                    case 2:
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.computeFees({ asset: openSeaAsset, side: types_1.OrderSide.Sell, isPrivate: isPrivate, extraBountyBasisPoints: extraBountyBasisPoints, paymentTokenAddress: paymentTokenAddress })];
                    case 2:
    ...
    OpenSeaPort.prototype._sellOrderValidationAndApprovals = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var wyAssets, schemaNames, tokenAddress, minimumAmount, sellOrder, sellValid;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters.callAsync(sellOrder, { from: accountAddress })];
                    case 4:
                        sellValid = _b.sent();
                        if (!sellValid) {
                            console.error(order);
    ...
    OpenSeaPort.prototype._approveOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var accountAddress, gasPrice, includeInOrderBook, orderToApprove, transactionHash;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.approveOrder.sendTransactionAsync(orderToApprove, includeInOrderBook, { from: accountAddress, gasPrice: gasPrice })];
                    case 2:
                        transactionHash = _a.sent();
    ...
    OpenSeaPort.prototype._validateOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var orderToValidate, orderToValidateSig, hash, isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        orderToValidate = {
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.hashOrder.callAsync(orderToValidate)];
                    case 1:
                        hash = _a.sent();
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrder.callAsync(hash, orderToValidate, orderToValidateSig)];
                    case 2:
                        isValid = _a.sent();
    ...
    OpenSeaPort.prototype._buyOrderValidationAndApprovals = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tokenAddress, balance, minimumAmount, buyOrder, buyValid;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        tokenAddress = order.paymentToken;
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters.callAsync(buyOrder, { from: accountAddress })];
                    case 6:
                        buyValid = _b.sent();
                        if (!buyValid) {
                            console.error(order);
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            var value, shouldValidateBuy, shouldValidateSell, txHash, txnData, buyOrder, sellOrder, buySig, sellSig, args, gasEstimate, _c, error_13, error_14;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.atomicMatch.estimateGasAsync(args[0], args[1], args[2], args[3], args[4], txnData)];
                    case 9:
                        gasEstimate = _d.sent();
                        _c = txnData;
                        return [4 /*yield*/, this._computeGasPrice()];
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.atomicMatch.sendTransactionAsync(args[0], args[1], args[2], args[3], args[4], txnData)];
                    case 13:
                        txHash = _d.sent();
                        return [3 /*break*/, 15];
                    case 14:
