...
var SwappablePort = /** @class */ (function () {
    ...
    SwappablePort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var isMainnet, isPaymentInSwap, openseaBuyerFeeBasisPoints, openseaSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_9, sellerBountyBasisPoints, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        openseaSellerFeeBasisPoints = (isPaymentInSwap ? constants_1.DEFAULT_SELLER_FEE_BASIS_POINTS_FOR_SWAP : constants_1.DEFAULT_SELLER_FEE_BASIS_POINTS);
