...
var SwappablePort = /** @class */ (function () {
    ...
    SwappablePort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, swappableAsset, taker, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _f, target, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times, _h, staticTarget, staticExtradata;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 2:
                        _d = _j.sent(), totalBuyerFeeBasisPoints = _d.totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints = _d.totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints = _d.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _d.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _d.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _d.devSellerFeeBasisPoints;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 2:
                        _c = _h.sent(), totalSellerFeeBasisPoints = _c.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _c.totalBuyerFeeBasisPoints, swappableBuyerFeeBasisPoints = _c.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _c.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _c.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _c.devSellerFeeBasisPoints, sellerBountyBasisPoints = _c.sellerBountyBasisPoints;
    ...
    SwappablePort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, orderedSchemas, taker, asset, _d, _e, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _g, calldata, replacementPattern, _h, basePrice, extra, paymentToken, times;
            var _this = this;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 4:
                        _d = _h.sent(), totalSellerFeeBasisPoints = _d.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _d.totalBuyerFeeBasisPoints, swappableBuyerFeeBasisPoints = _d.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _d.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _d.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _d.devSellerFeeBasisPoints, sellerBountyBasisPoints = _d.sellerBountyBasisPoints;
    ...
    SwappablePort.prototype._makeMatchingOrder = function (_a) {
        var _this = this;
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, devPayoutAddress = _a.devPayoutAddress;
        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3, accountAddress);
    ...
    SwappablePort.prototype.approveAll = function (_a) {
        var schemaNames = _a.schemaNames, assets = _a.assets, accountAddress = _a.accountAddress, proxyAddress = _a.proxyAddress;
        return __awaiter(this, void 0, void 0, function () {
            var wyAssets;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        wyAssets = assets.map(function (asset) { return utils_1.getWyvernAsset(_this._getSchema(asset.schemaName), asset); });
                        return [4 /*yield*/, this._approveAll({ schemaNames: schemaNames, wyAssets: wyAssets, accountAddress: accountAddress, proxyAddress: proxyAddress })];
