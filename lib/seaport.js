...
class SwappablePort {
    ...
    _validateOrder(order) {
        return __awaiter(this, void 0, void 0, function* () {
            const orderHash = yield this._wyvernProtocolReadOnly.wyvernExchange.hashToSign({
                exchange: order.exchange,
                maker: order.maker,
                taker: order.taker,
                makerRelayerFee: order.makerRelayerFee,
            ...
            const isValid = yield this._wyvernProtocolReadOnly.wyvernExchange.validateOrder(orderHash, {
                exchange: order.exchange,
                maker: order.maker,
                taker: order.taker,
                makerRelayerFee: order.makerRelayerFee,
    ...
    _atomicMatch({ buy, sell, accountAddress, metadata = constants_1.NULL_BLOCK_HASH }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const gasEstimate = yield this._wyvernProtocolReadOnly.wyvernExchange.atomicMatch({
                    exchange: buy.exchange,
                    maker: buy.maker,
                    taker: buy.taker,
                    makerRelayerFee: buy.makerRelayerFee,
            ...
            try {
                ...
                txHash = yield this._wyvernProtocol.wyvernExchange.atomicMatch({
                    exchange: buy.exchange,
                    maker: buy.maker,
                    taker: buy.taker,
                    makerRelayerFee: buy.makerRelayerFee,
