...
var SwappablePort = /** @class */ (function () {
    ...
    SwappablePort.prototype._makeSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, isPrivate, swappableAsset, _c, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, sellerBountyBasisPoints, _d, target, calldata, replacementPattern, orderSaleKind, _e, basePrice, extra, paymentToken, reservePrice, times, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _g, staticTarget, staticExtradata;
    ...
    SwappablePort.prototype._makeMatchingOrder = function (_a) {
        ...
        var feeRecipient = order.feeRecipient == constants_1.NULL_ADDRESS
            ? constants_1.SWAPPABLE_FEE_RECIPIENT
            : constants_1.NULL_ADDRESS;
        var matchingOrder = {
    ...
    SwappablePort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, sellOrder) {
        ...
        return {
            ...
            feeRecipient: constants_1.SWAPPABLE_FEE_RECIPIENT,
            feeMethod: types_1.FeeMethod.SplitFee
        };
    };
    SwappablePort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, waitForHighestBid, sellerBountyBasisPoints) {
