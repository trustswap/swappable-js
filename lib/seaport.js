...
var SwappablePort = /** @class */ (function () {
    /**
     ...
     *  information
     */
    function SwappablePort(provider, apiConfig, logger) {
        ...
        var providerURL = constants_1.RINKEBY_PROVIDER_URL;
        ...
        var readonlyProvider = new Web3.providers.HttpProvider(providerURL);
        // Web3 Config
     ...
     */
    SwappablePort.prototype.addListener = function (event, listener, once) {
     ...
     */
    SwappablePort.prototype.removeListener = function (subscription) {
        subscription.remove();
    };
    /**
     ...
     */
    SwappablePort.prototype.removeAllListeners = function (event) {
     ...
     */
    SwappablePort.prototype.wrapAssets = function (_a) {
     ...
     * @param accountAddress Address of the user's wallet
     */
    SwappablePort.prototype.unwrapAssets = function (_a) {
     ...
     */
    SwappablePort.prototype.liquidateAssets = function (_a) {
     ...
     * @param accountAddress Address of the user's wallet
     */
    SwappablePort.prototype.purchaseAssets = function (_a) {
     ...
     * @param contractAddress Address of the corresponding NFT core contract for these NFTs.
     */
    SwappablePort.prototype.getQuoteFromUniswap = function (_a) {
     ...
     */
    SwappablePort.prototype.wrapEth = function (_a) {
     ...
     */
    SwappablePort.prototype.unwrapWeth = function (_a) {
        var amountInEth = _a.amountInEth, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            var token, amount, gasPrice, txHash;
            var _this = this;
     ...
     */
    SwappablePort.prototype.createBundleBuyOrder = function (_a) {
     ...
     * @param referrerAddress The optional address that referred the order
     */
    SwappablePort.prototype.createBuyOrder = function (_a) {
     ...
     */
    SwappablePort.prototype.createBundleSellOrder = function (_a) {
     ...
     */
    SwappablePort.prototype.fulfillOrder = function (_a) {
        var _b;
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, referrerAddress = _a.referrerAddress, payouts = _a.payouts;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        matchingOrder = this._makeMatchingOrder({
                            ...
                            devPayoutAddress: (_b = order.asset) === null || _b === void 0 ? void 0 : _b.collection.payoutAddress,
                            payouts: payouts || []
                        });
                        _c = utils_1.assignOrdersToSides(order, matchingOrder), buy = _c.buy, sell = _c.sell;
    ...
    SwappablePort.prototype.atomicMatch = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this._atomicMatch({ buy: buy, sell: sell, accountAddress: accountAddress, metadata: metadata })];
                    case 1:
                        ...
                        return [4 /*yield*/, this._confirmTransaction(transactionHash, types_1.EventType.MatchOrders, "Fulfilling order", function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this._validateOrder(sell)];
                                        case 1:
                                            isOpen = _a.sent();
                                            return [2 /*return*/, !isOpen];
                                    }
     ...
     */
    SwappablePort.prototype.cancelOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        gasPrice = _b.sent();
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.cancelOrder({
                            ...
                            }).sendTransactionAsync({ from: accountAddress, gasPrice: gasPrice })];
                    case 2:
     ...
     */
    SwappablePort.prototype.approveSemiOrNonFungibleToken = function (_a) {
     ...
     */
    SwappablePort.prototype.approveFungibleToken = function (_a) {
     ...
     */
    SwappablePort.prototype.unapproveFungibleToken = function (_a) {
     ...
     */
    SwappablePort.prototype.getCurrentPrice = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var currentPrice;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.calculateCurrentPrice({
                            exchange: order.exchange,
                            maker: order.maker,
                            taker: order.taker,
                            makerRelayerFee: order.makerRelayerFee,
     ...
     * @param referrerAddress The optional address that referred the order
     */
    SwappablePort.prototype.isOrderFulfillable = function (_a) {
        var _b;
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, referrerAddress = _a.referrerAddress, payouts = _a.payouts;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SwappablePort.prototype.isAssetTransferrable = function (_a, retries) {
     ...
     * @returns Transaction hash
     */
    SwappablePort.prototype.transfer = function (_a) {
     ...
     * @returns Transaction hash
     */
    SwappablePort.prototype.transferAll = function (_a) {
     ...
     */
    SwappablePort.prototype.getFungibleTokens = function (_a) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __spreadArrays(offlineTokens, tokens)];
                }
            });
        });
    };
     ...
     */
    SwappablePort.prototype.getAssetBalance = function (_a, retries) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) {
                                var _a;
                                return (_a = contract_1[abi_1.name]).call.apply(_a, __spreadArrays([accountAddress], inputValues_1, [c]));
                            })];
                    case 1:
                        count = _b.sent();
                        if (count !== undefined) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, utils_1.promisifyCall(function (c) {
                                var _a;
                                return (_a = contract_2[abi_2.name]).call.apply(_a, __spreadArrays(inputValues_2, [c]));
                            })];
                    case 3:
                        owner = _b.sent();
                        if (owner) {
     ...
     */
    SwappablePort.prototype.getTokenBalance = function (_a, retries) {
     ...
     */
    SwappablePort.prototype.computeFees = function (_a) {
        var asset = _a.asset, side = _a.side, accountAddress = _a.accountAddress, _b = _a.isPrivate, isPrivate = _b === void 0 ? false : _b, _c = _a.extraBountyBasisPoints, extraBountyBasisPoints = _c === void 0 ? 0 : _c, paymentTokenAddress = _a.paymentTokenAddress;
        return __awaiter(this, void 0, void 0, function () {
            var isPaymentInSwap, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_9, sellerBountyBasisPoints, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        isPaymentInSwap = false;
                        switch (this._networkName) {
                            case types_1.Network.Main:
                        ...
                        swappableBuyerFeeBasisPoints = constants_1.DEFAULT_BUYER_FEE_BASIS_POINTS;
                        swappableSellerFeeBasisPoints = (isPaymentInSwap ? constants_1.DEFAULT_SELLER_FEE_BASIS_POINTS_FOR_SWAP : constants_1.DEFAULT_SELLER_FEE_BASIS_POINTS);
                    ...
                    case 4:
                        sellerBountyBasisPoints = side == types_1.OrderSide.Sell
                            ...
                            : 0;
                        bountyTooLarge = sellerBountyBasisPoints + constants_1.SWAPPABLE_SELLER_BOUNTY_BASIS_POINTS > maxTotalBountyBPS;
                        ...
                        return [2 /*return*/, {
                                ...
                                swappableBuyerFeeBasisPoints: swappableBuyerFeeBasisPoints,
                                swappableSellerFeeBasisPoints: swappableSellerFeeBasisPoints,
     ...
     */
    SwappablePort.prototype.validateAndPostOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var hash, confirmedOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.hashOrder({
                            exchange: order.exchange,
                            maker: order.maker,
                            taker: order.taker,
                            makerRelayerFee: order.makerRelayerFee,
     ...
     */
    SwappablePort.prototype._computeGasPrice = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        meanGas = _a.sent();
                        weiToAdd = this.web3.toWei(this.gasPriceAddition.toString(), 'gwei');
     ...
     */
    SwappablePort.prototype._correctGasAmount = function (estimation) {
     ...
     */
    SwappablePort.prototype._estimateGasForMatch = function (_a, retries) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b;
        if (retries === void 0) { retries = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var value, error_10;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.trys.push([2, 4, , 7]);
                        return [4 /*yield*/, this._getClientsForRead(retries).wyvernProtocol.wyvernExchange.atomicMatch({
     ...
     */
    SwappablePort.prototype._estimateGasForTransfer = function (_a) {
        var assets = _a.assets, fromAddress = _a.fromAddress, toAddress = _a.toAddress, _b = _a.schemaName, schemaName = _b === void 0 ? types_1.WyvernSchemaName.ERC721 : _b;
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SwappablePort.prototype._getProxy = function (accountAddress, retries) {
        if (retries === void 0) { retries = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var proxyAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernProxyRegistry.proxies(accountAddress).callAsync()];
                    case 1:
     ...
     * @param accountAddress The user's wallet address
     */
    SwappablePort.prototype._initializeProxy = function (accountAddress) {
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    SwappablePort.prototype._getApprovedTokenCount = function (_a) {
        var accountAddress = _a.accountAddress, tokenAddress = _a.tokenAddress, proxyAddress = _a.proxyAddress;
        return __awaiter(this, void 0, void 0, function () {
    ...
    SwappablePort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, swappableAsset, taker, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _f, target, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times, _h, staticTarget, staticExtradata, _j, dataType, data;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        swappableAsset = _k.sent();
                        taker = sellOrder
                            ? sellOrder.maker
                            : constants_1.NULL_ADDRESS;
                        return [4 /*yield*/, this.computeFees({ asset: swappableAsset, extraBountyBasisPoints: extraBountyBasisPoints, side: types_1.OrderSide.Buy, paymentTokenAddress: paymentTokenAddress })];
                    case 2:
                        _d = _k.sent(), totalBuyerFeeBasisPoints = _d.totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints = _d.totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints = _d.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _d.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _d.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _d.devSellerFeeBasisPoints;
                        _e = this._getBuyFeeParameters(totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, swappableAsset === null || swappableAsset === void 0 ? void 0 : swappableAsset.collection.payoutAddress, sellOrder), makerRelayerFee = _e.makerRelayerFee, takerRelayerFee = _e.takerRelayerFee, makerProtocolFee = _e.makerProtocolFee, takerProtocolFee = _e.takerProtocolFee, makerReferrerFee = _e.makerReferrerFee, feeRecipient = _e.feeRecipient, feeMethod = _e.feeMethod;
                    ...
                    case 3:
                        _g = _k.sent(), basePrice = _g.basePrice, extra = _g.extra, paymentToken = _g.paymentToken;
                        times = this._getTimeParameters(expirationTime);
                        return [4 /*yield*/, this._getStaticCallTargetAndExtraData({ asset: swappableAsset, useTxnOriginStaticCall: false })];
                    case 4:
                        _h = _k.sent(), staticTarget = _h.staticTarget, staticExtradata = _h.staticExtradata;
                        _j = wyvern_js_1.WyvernProtocol.encodeOrderData({
                            dataType: "ORDER_DATA_TYPE_V1",
                            payouts: [],
                            originFees: []
                        }), dataType = _j[0], data = _j[1];
                        return [2 /*return*/, {
    ...
    SwappablePort.prototype._makeSellOrder = function (_a) {
        var asset = _a.asset, quantity = _a.quantity, accountAddress = _a.accountAddress, startAmount = _a.startAmount, endAmount = _a.endAmount, expirationTime = _a.expirationTime, waitForHighestBid = _a.waitForHighestBid, _b = _a.englishAuctionReservePrice, englishAuctionReservePrice = _b === void 0 ? 0 : _b, paymentTokenAddress = _a.paymentTokenAddress, extraBountyBasisPoints = _a.extraBountyBasisPoints, buyerAddress = _a.buyerAddress, payouts = _a.payouts;
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, isPrivate, swappableAsset, _c, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, sellerBountyBasisPoints, _d, target, calldata, replacementPattern, orderSaleKind, _e, basePrice, extra, paymentToken, reservePrice, times, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _g, staticTarget, staticExtradata, _h, dataType, data;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.getAsset(asset)];
                    case 1:
                        swappableAsset = _j.sent();
                        return [4 /*yield*/, this.computeFees({ asset: swappableAsset, side: types_1.OrderSide.Sell, isPrivate: isPrivate, extraBountyBasisPoints: extraBountyBasisPoints, paymentTokenAddress: paymentTokenAddress })];
                    case 2:
                        _c = _j.sent(), totalSellerFeeBasisPoints = _c.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _c.totalBuyerFeeBasisPoints, swappableBuyerFeeBasisPoints = _c.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _c.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _c.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _c.devSellerFeeBasisPoints, sellerBountyBasisPoints = _c.sellerBountyBasisPoints;
                    ...
                    case 3:
                        _e = _j.sent(), basePrice = _e.basePrice, extra = _e.extra, paymentToken = _e.paymentToken, reservePrice = _e.reservePrice;
                        times = this._getTimeParameters(expirationTime, waitForHighestBid);
                        _f = this._getSellFeeParameters(totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, waitForHighestBid, swappableAsset === null || swappableAsset === void 0 ? void 0 : swappableAsset.collection.payoutAddress, sellerBountyBasisPoints), makerRelayerFee = _f.makerRelayerFee, takerRelayerFee = _f.takerRelayerFee, makerProtocolFee = _f.makerProtocolFee, takerProtocolFee = _f.takerProtocolFee, makerReferrerFee = _f.makerReferrerFee, feeRecipient = _f.feeRecipient, feeMethod = _f.feeMethod;
                        return [4 /*yield*/, this._getStaticCallTargetAndExtraData({ asset: swappableAsset, useTxnOriginStaticCall: waitForHighestBid })];
                    case 4:
                        _g = _j.sent(), staticTarget = _g.staticTarget, staticExtradata = _g.staticExtradata;
                        _h = wyvern_js_1.WyvernProtocol.encodeOrderData({
                            dataType: "ORDER_DATA_TYPE_V1",
                            payouts: payouts,
                            originFees: []
                        }), dataType = _h[0], data = _h[1];
                        return [2 /*return*/, {
                                exchange: wyvern_js_1.WyvernProtocol.getExchangeContractAddress(this._networkName),
                                maker: accountAddress,
                                taker: buyerAddress,
    ...
    SwappablePort.prototype._getStaticCallTargetAndExtraData = function (_a) {
        var asset = _a.asset, useTxnOriginStaticCall = _a.useTxnOriginStaticCall;
        return __awaiter(this, void 0, void 0, function () {
            var isCheezeWizards, isDecentralandEstate, isMainnet, cheezeWizardsBasicTournamentAddress, cheezeWizardsBasicTournamentABI, cheezeWizardsBasicTournmentInstance, wizardFingerprint, decentralandEstateAddress, decentralandEstateABI, decentralandEstateInstance, estateFingerprint, STATIC_CALL_TX_ADDRESS;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        isCheezeWizards = [
                        ...
                        isMainnet = (this._networkName == types_1.Network.Main || this._networkName == types_1.Network.Matic);
                    ...
                    case 6:
                        if (useTxnOriginStaticCall) {
                            STATIC_CALL_TX_ADDRESS = constants_1.STATIC_CALL_TX_ORIGIN_RINKEBY_ADDRESS;
                            switch (this._networkName) {
                                case types_1.Network.Mumbai:
    ...
    SwappablePort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, orderedSchemas, taker, asset, _d, _e, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _g, calldata, replacementPattern, _h, basePrice, extra, paymentToken, times, _j, dataType, data;
            var _this = this;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                    ...
                    case 3:
                        asset = _d;
                        return [4 /*yield*/, this.computeFees({ asset: asset, extraBountyBasisPoints: extraBountyBasisPoints, side: types_1.OrderSide.Buy, paymentTokenAddress: paymentTokenAddress })];
                    case 4:
                        _e = _k.sent(), totalBuyerFeeBasisPoints = _e.totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints = _e.totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints = _e.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _e.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _e.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _e.devSellerFeeBasisPoints;
                        _f = this._getBuyFeeParameters(totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, asset === null || asset === void 0 ? void 0 : asset.collection.payoutAddress, sellOrder), makerRelayerFee = _f.makerRelayerFee, takerRelayerFee = _f.takerRelayerFee, makerProtocolFee = _f.makerProtocolFee, takerProtocolFee = _f.takerProtocolFee, makerReferrerFee = _f.makerReferrerFee, feeRecipient = _f.feeRecipient, feeMethod = _f.feeMethod;
    ...
    SwappablePort.prototype._makeBundleSellOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, orderedSchemas, isPrivate, asset, _c, _d, totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, sellerBountyBasisPoints, _e, calldata, replacementPattern, _f, basePrice, extra, paymentToken, reservePrice, times, orderSaleKind, _g, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, _h, dataType, data;
            var _this = this;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                    ...
                    case 3:
                        asset = _c;
                        return [4 /*yield*/, this.computeFees({ asset: asset, side: types_1.OrderSide.Sell, isPrivate: isPrivate, extraBountyBasisPoints: extraBountyBasisPoints, paymentTokenAddress: paymentTokenAddress })];
                    case 4:
                        _d = _j.sent(), totalSellerFeeBasisPoints = _d.totalSellerFeeBasisPoints, totalBuyerFeeBasisPoints = _d.totalBuyerFeeBasisPoints, swappableBuyerFeeBasisPoints = _d.swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints = _d.swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints = _d.devBuyerFeeBasisPoints, devSellerFeeBasisPoints = _d.devSellerFeeBasisPoints, sellerBountyBasisPoints = _d.sellerBountyBasisPoints;
                    ...
                    case 5:
                        ...
                        orderSaleKind = endAmount != null && endAmount !== startAmount
                            ? types_1.SaleKind.DutchAuction
                            : types_1.SaleKind.FixedPrice;
                        _g = this._getSellFeeParameters(totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, waitForHighestBid, asset === null || asset === void 0 ? void 0 : asset.collection.payoutAddress, sellerBountyBasisPoints), makerRelayerFee = _g.makerRelayerFee, takerRelayerFee = _g.takerRelayerFee, makerProtocolFee = _g.makerProtocolFee, takerProtocolFee = _g.takerProtocolFee, makerReferrerFee = _g.makerReferrerFee, feeRecipient = _g.feeRecipient;
                        _h = wyvern_js_1.WyvernProtocol.encodeOrderData({
                            dataType: "ORDER_DATA_TYPE_V1",
                            payouts: [],
                            originFees: []
    ...
    SwappablePort.prototype._makeMatchingOrder = function (_a) {
        var _this = this;
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, devPayoutAddress = _a.devPayoutAddress, payouts = _a.payouts;
        accountAddress = utils_1.validateAndFormatWalletAddress(this.web3, accountAddress);
        ...
        var _c = wyvern_js_1.WyvernProtocol.encodeOrderData({
            dataType: "ORDER_DATA_TYPE_V1",
            payouts: order.side == types_1.OrderSide.Sell ? [] : payouts,
            originFees: []
        }), dataType = _c[0], data = _c[1];
        var matchingOrder = {
            exchange: order.exchange,
            maker: accountAddress,
            taker: order.maker,
     ...
     */
    SwappablePort.prototype._validateMatch = function (_a, retries) {
    ...
    SwappablePort.prototype._createEmailWhitelistEntry = function (_a) {
    ...
    // Throws
    SwappablePort.prototype._sellOrderValidationAndApprovals = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters({
                            exchange: order.exchange,
                            maker: order.maker,
                            taker: order.taker,
                            makerRelayerFee: order.makerRelayerFee,
     ...
     */
    SwappablePort.prototype._approveOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.approveOrder({
                                exchange: order.exchange,
                                maker: order.maker,
                                taker: order.taker,
                                makerRelayerFee: order.makerRelayerFee,
    ...
    SwappablePort.prototype._validateOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
            var orderHash, isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.hashToSign({
                            exchange: order.exchange,
                            maker: order.maker,
                            taker: order.taker,
                            makerRelayerFee: order.makerRelayerFee,
                    ...
                    case 1:
                        orderHash = _a.sent();
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrder(orderHash, {
                                exchange: order.exchange,
                                maker: order.maker,
                                taker: order.taker,
                                makerRelayerFee: order.makerRelayerFee,
    ...
    SwappablePort.prototype._approveAll = function (_a) {
    ...
    // Throws
    SwappablePort.prototype._buyOrderValidationAndApprovals = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        _b.sent();
                        _b.label = 5;
                    case 5: return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.validateOrderParameters({
                            exchange: order.exchange,
                            maker: order.maker,
                            taker: order.taker,
                            makerRelayerFee: order.makerRelayerFee,
     ...
     */
    SwappablePort.prototype._ownsAssetOnChain = function (_a) {
    ...
    SwappablePort.prototype._getBuyFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, devPayoutAddress, sellOrder) {
        ...
        var feeRecipient = devPayoutAddress || constants_1.SWAPPABLE_FEE_RECIPIENT;
        var makerRelayerFee;
        var takerRelayerFee;
        var makerProtocolFee;
        var takerProtocolFee;
        if (sellOrder) {
    ...
    SwappablePort.prototype._getSellFeeParameters = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, waitForHighestBid, devPayoutAddress, sellerBountyBasisPoints) {
     ...
     */
    SwappablePort.prototype._validateFees = function (totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints) {
     ...
     */
    SwappablePort.prototype._getTimeParameters = function (expirationTimestamp, waitingForBestCounterOrder) {
     ...
     */
    SwappablePort.prototype._getPriceParameters = function (orderSide, tokenAddress, expirationTime, startAmount, endAmount, waitingForBestCounterOrder, englishAuctionReservePrice) {
        if (waitingForBestCounterOrder === void 0) { waitingForBestCounterOrder = false; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    SwappablePort.prototype._getMetadata = function (order, referrerAddress) {
    ...
    SwappablePort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 8:
                        ...
                        return [4 /*yield*/, this._wyvernProtocolReadOnly.wyvernExchange.atomicMatch({
                                exchange: buy.exchange,
                                maker: buy.maker,
                                taker: buy.taker,
                                makerRelayerFee: buy.makerRelayerFee,
                    ...
                    case 11:
                        ...
                        throw new Error("Oops, the Ethereum network rejected this transaction :( The Swappable devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"" + error_13.message.substr(0, debugging_1.MAX_ERROR_LENGTH) + "...\"");
                    case 12:
                        _d.trys.push([12, 14, , 15]);
                        this.logger("Fulfilling order with gas set to " + txnData.gas);
                        return [4 /*yield*/, this._wyvernProtocol.wyvernExchange.atomicMatch({
                                exchange: buy.exchange,
                                maker: buy.maker,
                                taker: buy.taker,
                                makerRelayerFee: buy.makerRelayerFee,
    ...
    SwappablePort.prototype._getRequiredAmountForTakingSellOrder = function (sell) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, fee.plus(maxPrice).dp(0, 2)];
                }
            });
        });
    };
    SwappablePort.prototype._authorizeOrder = function (order) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SwappablePort.prototype._getSchema = function (schemaName) {
    ...
    SwappablePort.prototype._dispatch = function (event, data) {
     ...
     */
    SwappablePort.prototype._getClientsForRead = function (retries) {
        if (retries === void 0) { retries = 1; }
        if (retries > 0) {
    ...
    SwappablePort.prototype._confirmTransaction = function (transactionHash, event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SwappablePort.prototype._pollCallbackForConfirmation = function (event, description, testForSuccess) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
