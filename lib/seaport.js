...
var SwappablePort = /** @class */ (function () {
    ...
    SwappablePort.prototype.computeFees = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var isMainnet, isPaymentInSwap, swappableBuyerFeeBasisPoints, swappableSellerFeeBasisPoints, devBuyerFeeBasisPoints, devSellerFeeBasisPoints, transferFee, transferFeeTokenAddress, maxTotalBountyBPS, result, error_9, sellerBountyBasisPoints, bountyTooLarge, errorMessage;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        isMainnet = this._networkName == types_1.Network.Main;
                        isPaymentInSwap = (isMainnet ? paymentTokenAddress == constants_1.SWAP_TOKEN_ADDRESS : paymentTokenAddress == constants_1.SWAP_TOKEN_RINKEBY_ADDRESS);
