...
exports.annotateERC721TransferABI = (asset) => ({
    "constant": false,
    "inputs": [
        {
            "name": "_to",
...
exports.annotateERC20TransferABI = (asset) => ({
    "constant": false,
    "inputs": [
        {
            "name": "_to",
...
exports.confirmTransaction = (web3, txHash) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.assetEventFromJSON = (assetEvent) => {
    return {
...
exports.transactionFromJSON = (transaction) => {
    return {
...
exports.accountFromJSON = (account) => {
    return {
...
exports.userFromJSON = (user) => {
    return {
        username: user.username
    };
};
exports.assetBundleFromJSON = (asset_bundle) => {
    const fromJSON = {
...
exports.assetContractFromJSON = (asset_contract) => {
    return {
...
exports.collectionFromJSON = (collection) => {
...
exports.orderToJSON = (order) => {
    ...
    const asJSON = {
        ...
        feeRecipient: (_a = order.feeRecipient) === null || _a === void 0 ? void 0 : _a.toLowerCase(),
        side: order.side,
...
function getOrderHash(order) {
    var _a;
    const orderWithStringTypes = Object.assign(Object.assign({}, order), { maker: order.maker.toLowerCase(), taker: order.taker.toLowerCase(), feeRecipient: (_a = order.feeRecipient) === null || _a === void 0 ? void 0 : _a.toLowerCase(), side: order.side.toString(), saleKind: order.saleKind.toString(), howToCall: order.howToCall.toString(), feeMethod: order.feeMethod.toString() });
...
function canSettleOrder(client, order, matchingOrder) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const proxy = yield client._getProxy(seller);
        if (!proxy) {
