...
// Wyvern Schemas (see https://github.com/ProjectSwappable/wyvern-schemas)
...
export interface SwappableAccount {
  ...
  address: string
  // Public configuration info, including "affiliate" for users who are in the Swappable affiliate program
  config: string

  // This account's profile image - by default, randomly generated by the server
  profileImgUrl: string

  // More information explicitly set by this account's owner on Swappable
...
export interface SwappableAssetContract extends SwappableFees {
  ...
  description: string
  // Contract's Etherscan / Swappable symbol
  tokenSymbol: string
...
// Backwards compat
export type FungibleToken = SwappableFungibleToken
...
// Backwards compat
export type FungibleTokenQuery = SwappableFungibleTokenQuery
