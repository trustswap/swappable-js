...
export const SWAPPABLE_FEE_RECIPIENT = '0x5b3256965e7c3cf26e11fcaf296dfc8807c01073'
export const DEP_INFURA_KEY = 'e8695bce67944848aa95459fac052f8e'
export const MAINNET_PROVIDER_URL = 'https://api.swappable.io/jsonrpc/v1/'
export const RINKEBY_PROVIDER_URL = 'https://rinkeby-api.swappable.io/jsonrpc/v1/'
...
export const API_BASE_RINKEBY = 'https://rinkeby-api.swappable.io'
export const SITE_HOST_MAINNET = 'https://swappable.io'
export const SITE_HOST_RINKEBY = 'https://rinkeby.swappable.io'
